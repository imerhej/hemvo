...
struct SubscriptionStatusView: View {
    ...
    private var statusSubtitle: String {
        ...
        if isActive { return "Full access to all HomeBase features" }
    ...
    var body: some View {
        NavigationStack {
            ...
            .alert("Cancel Subscription", isPresented: $showCancelInfo) {
                ...
                Text("To cancel, go to Settings → Apple ID → Subscriptions and select HomeBase.")
            }
        }
    }
